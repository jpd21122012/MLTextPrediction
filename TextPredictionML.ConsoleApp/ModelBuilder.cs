...
namespace TextPredictionML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\vs2019\AI\TextPrediction\TextPrediction.Client\SentimentAnalisys.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\slipk\AppData\Local\Temp\MLVSTools\TextPredictionML\TextPredictionML.Model\MLModel.zip";
